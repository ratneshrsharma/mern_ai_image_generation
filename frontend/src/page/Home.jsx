...
const Home = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#000a64] text-[32px]">The Community Showcase</h1>
      ...
      <div className="mt-10">
        {loading ? (
          ...
          <>
            ...
            <div className="grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-3 grid-cols-2 gap-3">
              {searchText ? (
                <RenderCards
